...
this is similar to the volume_mf_um.py
except that the diffusion equation is solved on
the fixed mesh (i.e. use disp_func_space
everywhere disp_func_space is used)
"""
