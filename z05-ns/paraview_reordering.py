...
# if we want to get paraview high-order elements ordering, use the following print out lines
# tetrahedron. put element order in the parameter
order = 1
print('tetrahedron of order %d'%order)
print(vtk_tet_local_to_cart(order))
# triangle.
order = 3
print('triangle of order %d'%order)
print(vtk_triangle_local_to_cart(order))
