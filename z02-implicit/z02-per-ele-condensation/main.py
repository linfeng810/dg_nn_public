...
from surface_integral import S_Minv_sparse, RSR_matrix
...
[diagRSR, RSR, Rbig] = RSR_matrix(S,R)
...
for itime in tqdm(range(1,tstep)):
    ...
    # passing r1 to next level coarse grid and solve Ae=r1
    r1_1 = torch.matmul(r1.view(-1,nloc), R.view(nloc,1)) # restrict residual to coarser mesh, (nele, 1)
