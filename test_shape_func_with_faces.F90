program test_shape_func_with_faces
    implicit none 

    integer :: ndim=2, nloc=10
    integer :: sngi=10, ngi=14, nface=3, max_face_list_no=2, &
        snloc=1
    integer :: npoly=3, ele_type=100
   !  integer :: ndim=2, nloc=3
   !  integer :: sngi=2, ngi=3, nface=3, max_face_list_no=2, &
   !      snloc=2
   !  integer :: npoly=1, ele_type=100
